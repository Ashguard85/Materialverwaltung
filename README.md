...
- Fix: `/api/bootstrap` returned HTTP 500 because the projects list referenced an undefined variable.
- Added explicit bootstrap smoke test.
- Unexpected backend exceptions are logged with route and stack trace; API clients receive a generic JSON 500 response.
 · Docker · v13
...
Service-Worker-Cache: `maker-inventar-pwa-v13`.
...
Docker v13 ↔ Pages v13. Backupformat Version 3 ergänzt 3D-Projektdateien; Version 1 und 2 bleiben importierbar; v9 entfernt die Tags-Funktion aus UI, API-Ausgabe, CSV und neuen Backups. Bei Änderungen an API, Datenmodell, Provider, Backupformat oder Service Worker beide Pakete gemeinsam versionieren.
...
- regulär kein `clients.claim()`; nur der einmalige v11→v13-Übergang nutzt eine Kompatibilitätsbrücke, danach wechseln laufende Clients nur über kontrollierten Reload/Neustart
